...
<html lang="en">
  ...
  <body style="background: -webkit-linear-gradient(left, #1b1a1f, #097a9b); background-size: cover;">
  <nav class="navbar navbar-expand-lg navbar-dark fixed-top" style="background: -webkit-linear-gradient(left, #1b1a1f, #097a9b);" id="mainNav" >
    ...
    animation: mover 1s infinite alternate;">
          <img src="images/cardback.jpeg" alt="" style="width: 60%;padding-left: 40px;margin-top: 150px;margin-left: 45px;margin-bottom:15px;border-radius: 15px;">
      </div>

      <div style="color: white;">
            <h4 style="font-family: 'IBM Plex Sans', sans-serif;padding-left: 25%;"> We are here for you!</h4>
          </div>
         ...
         <div class="col-md-4" style="margin-top: 5%;right: 8%">
          <div class="card" style="font-family: 'IBM Plex Sans', sans-serif;">
              ...
              <form class="form-group" method="POST" action="func.php">
                ...
                <div class="row">
                 ...
                 <!--  <div class="col-md-8" style="margin-top: 10%">
                    <a href="index1.php" class="btn btn-primary">Back</a></div> -->
                </div>
              </form>
            </center>
            <!-- <hr>
            <div class="row">
              ...
              <div class="col-lg-6 text-center">
                <a class="btn btn-primary" href="doctor-login.php">Login as Doctor</a>
              </div>
            </div> -->
            </div>
          </div>
