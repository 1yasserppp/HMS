...
include('func.php');  
include('newfunc.php');
$con=mysqli_connect("localhost:3306","root","","myhmsdb");
$pid = $_SESSION['pid'];
...
if(isset($_POST['prescribe']))
{
  ...
  // Ensure proper quoting and escaping of variables
  $pid = mysqli_real_escape_string($con, $pid);
  $username = mysqli_real_escape_string($con, $username);
  $doctor = mysqli_real_escape_string($con, $doctor);
  $question = mysqli_real_escape_string($con, $question);

  $query = "INSERT INTO questionanswers (p_id, username, d_username, question, answer) 
  VALUES ('$pid', '$username', '$doctor', '$question', '')";
...
<body style="padding-top:50px;">
   ...
   <div class="tab-pane" id="list-pres" role="tabpanel" aria-labelledby="list-pres-list">
        <form class="form-group" method="post" action="ask-question.php?id=<?php echo $doctor;?>">
          ...
          <div class="row">
                  ...
                  <div class="row w-100">
                    <div class="col-12 text-center">
                      ...
                      <input type="submit" name="prescribe" value="Send Question" class="btn btn-primary">
                    </div>
                  </div>
