...
//     var con = mysqli_connect("localhost","root","","myhmsdb");
...
//     // Update the doctorStatus based on the state
//     var query;
//     if (state == 1) {
//         query = "UPDATE appointmenttb SET doctorStatus = '1' WHERE ID = " + id;
//     } else if (state == 0) {
//         query = "UPDATE appointmenttb SET doctorStatus = '0' WHERE ID = " + id;
//     }

//     // Execute the query
//     mysqli_query(con, query, function(err, result) {
//         if (err) {
//             console.log("Unable to process your request. Please try again!");
//         } else {
//             if (state == 1) {
//                 console.log("Your appointment successfully approved");
//             } else if (state == 0) {
//                 console.log("Your appointment successfully rejected");
//             }
//         }
//     });
// }
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  ...
                  ?>
                    ...
                    // {
                    //   echo "Aproaved by doctor and user";
                    // }
                    ...
                    }else if(($row['adminStatus']==2))  
                    {
                      echo "Rejected by admin";
                        ...
                        ?>
                          <button class="btn btn-success" onclick="reservation(1,<?php echo $row['ID']; ?>)">Accept</button>
                          <button class="btn btn-danger ml-2" onclick="reservation(0,<?php echo $row['ID']; ?>)">Reject</button>
                        <?php }?> 
                        </td>
                      </tr>
                    <?php } ?>
