    ...
    if((date("Y-m-d",$appdate1)==$cur_date and date("H:i:s",$apptime1)>$cur_time) or date("Y-m-d",$appdate1)>$cur_date) {
      $check_query = mysqli_query($con,"select apptime from appointmenttb where doctor='$doctor' and appdate='$appdate' and apptime='$apptime'");
        ...
        if(mysqli_num_rows($check_query)==0){
          $query=mysqli_query($con,"insert into appointmenttb(pid,fname,lname,gender,email,contact,doctor,docFees,appdate,apptime,userStatus,doctorStatus,adminStatus) values($pid,'$fname','$lname','$gender','$email','$contact','$doctor','$docFees','$appdate','$apptime','1','1','0')");
...
.btn-primary{
  ...
  <div class="col-md-4" style="max-width:25%; margin-top: 3%">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-ques" id="list-ques-list" role="tab" data-toggle="list" aria-controls="home">My Questions</a>
...
<div class="tab-pane fade" id="app-hist" role="tabpanel" aria-labelledby="list-pat-list">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    $query = "select ID,adminStatus,doctor,docFees,appdate,apptime,userStatus,doctorStatus from appointmenttb where fname ='$fname' and lname='$lname';";
                  ...
                  ?>
                    ...
                    // }
                        ...
                        {
                          echo "<span class='badge badge-secondary'>Waiting for admin to accept</span>";
                        }else if(($row['adminStatus']==1))  
                        {
                          echo "<span class='badge badge-primary'>Accepted by Admin</span>";
                        }else if(($row['adminStatus']==2))  
                        {
                          echo "<span class='badge badge-danger'>Rejected by Admin</span>";
                        }
                        ?>
                          <!-- <span class="badge badge-secondary">Waiting for admin to accept</span> -->
                      ...
                      <tr>
                        ...
                        <td>
                          ...
                          <!-- <a href="admin-panel.php?ID=" 
                            ...
                            <td>
                              <a class="btn btn-success" href="ask-question.php?id=<?php echo $row['doctor'];?>">Ask Question</a>
                            </td>
                            <td>
                           
                               <a class="btn btn-success" href="send-feedback.php?id=<?php echo $row['ID']?>">Send Feedback</a>
                            </td>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
       ...
       <div class="tab-pane fade" id="list-ques" role="tabpanel" aria-labelledby="list-ques-list">
              <table class="table table-hover">
                <thead>
                ...
                $query = "select question,answer from questionanswers where p_id='$pid';";
