          ...
          <div class="row">
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <textarea id="disease" class="form-control" cols="86" rows ="5" name="disease" required></textarea>
                    </div>
                  </div>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <textarea id="allergy" class="form-control" cols="86" rows ="5" name="allergy" required></textarea>
                    </div>
                  </div>
                  <div class="col-md-4">
                    <div class="form-group">
                      ...
                      <textarea id="prescription" class="form-control" cols="86" rows ="5" name="prescription" required></textarea>
                    </div>
                  </div>
