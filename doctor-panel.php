...
.text-primary {
  ...
  <div class="col-md-4" style="max-width:18%;margin-top: 3%;">
    <div class="list-group" id="list-tab" role="tablist">
      ...
      <a class="list-group-item list-group-item-action" href="#list-ans" id="list-ans-list" role="tab" data-toggle="list" aria-controls="home"> Questions</a>
      <dback class="list-group-item list-group-item-action" href="#list-feedback" id="list-feedback-list" role="tab" data-toggle="list" aria-controls="home"> Feedback</dback>
  ...
  <div class="col-md-8" style="margin-top: 3%;">
    ...
    <div class="tab-pane fade" id="list-app" role="tabpanel" aria-labelledby="list-home-list">
              ...
              <table class="table table-hover">
                ...
                <tbody>
                  <?php 
                    ...
                    //get all data when admin accepte
                    $query = "select pid,ID,adminStatus,fname,lname,gender,email,contact,appdate,apptime,userStatus,doctorStatus from appointmenttb where adminStatus=1 and doctor='$dname';";
                    ...
                    // }
                        ?>
                        <span class='badge badge-primary'>Accepted by Admin</span></td>
      ...
      <div class="tab-pane fade" id="list-settings" role="tabpanel" aria-labelledby="list-settings-list">
       ...
       <div class="tab-pane fade" id="list-ans" role="tabpanel" aria-labelledby="list-ans-list">
       <table class="table table-hover">
                <thead>
                  <tr>
...
$query = "select id,question,answer,username from questionanswers where d_username='$dname';";
...
?>
                      ...
                      <td><?php echo $row['question']; ?></td>
                        ...
                        <td>
                          <a class="btn btn-success" href="answer-question.php?id=<?php echo $row['id']; ?>">Answer</a>
                        </td>
                      </tr>
                      <?php }?>
                </tbody>
...
$query = "select fname,feedback from appointmenttb where doctor='$dname' and feedback is not null;";
