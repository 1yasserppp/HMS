                ...
                <a class="btn btn-primary" href="doctor-login.php">Login as Doctor</a>
                            ...
                            <div class="tab-pane fade show" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-12">
                                      <p style="color: red;font-size: 18px;" id="errorMsg2"></p>
                                    </div>
                            ...
                            <div class="tab-pane fade show" id="admin" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="row register-form">
                                    ...
                                    <div class="col-md-12">
                                      <p style="color: red;font-size: 18px;" id="errorMsg"></p>
                                    </div>
                                </div>
                            </form>
                            </div>
...
<div class="container">
  <div class="row">
    ...
    <script>
      ...
      setTimeout(function(){ document.getElementById('errorMsg').innerHTML = localStorage.getItem('showError') }, 1000);
      setTimeout(function(){ 
...
<script>
      ...
      setTimeout(function(){ document.getElementById('errorMsg2').innerHTML = localStorage.getItem('showError2') }, 1000);
      setTimeout(function(){ 
        localStorage.removeItem('showError2') 
